...
{
    public class OgretmenYorumValidator:AbstractValidator<OgretmenYorum>
    {
        public OgretmenYorumValidator()
        {
            ...
            RuleFor(c => c.OgretmenId).NotEmpty().WithMessage("OgretmenId alanı boş geçilemez!");
        }
    }
}
